...
insert  into `pby_pengajuan`(`id`,`id_anggota`,`id_order`,`id_pinjaman`,`no_rek`,`no_pengajuan`,`tanggal`,`jenis`,`nominal`,`jangka`,`keperluan`,`jaminan`,`user_id`,`status_pengajuan`,`tgl_ubah`,`keterangan`,`created_at`,`updated_at`) values (1,13,0,1,'0015000001','P012306260001','2023-06-26','Pinjaman Tunai',7000000.00,6,'modal','Tanpa Jaminan',31,'Disetujui','2023-06-26','','2023-06-26 11:10:35','2023-06-26 11:13:12');
...
CREATE TABLE `sys_notification` (
  ...
  `tanggal` date DEFAULT NULL,
  `jenis` enum('Pinjaman','Simpanan','Anggota','Setoran','Angsuran') NOT NULL,
  `keterangan` varchar(255) NOT NULL DEFAULT '',
...
insert  into `sys_notification`(`id`,`id_anggota`,`id_reksimp`,`id_rekpby`,`tanggal`,`jenis`,`keterangan`,`role`,`is_read`,`user_id`,`created_at`,`updated_at`) values (1,20,0,0,'2023-07-07','Anggota','Mendaftar Sebagai Anggota','Admin',1,1,'2023-07-07 15:19:13','2023-07-08 00:29:48'),(3,21,0,0,'2023-07-09','Anggota','Mendaftar Sebagai Anggota','Admin',1,1,'2023-07-09 01:54:12','2023-07-09 01:54:12'),(4,21,0,0,'2023-07-09','Anggota','Mendaftar Sebagai Anggota','Admin',0,39,'2023-07-09 01:54:12','2023-07-09 01:54:12');
