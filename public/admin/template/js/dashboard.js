(function($) {
  ...
  $(function() {
    if ($("#shu-chart").length) {
      var ShuChartCanvas = $("#shu-chart").get(0).getContext("2d");
      var ShuChart = new Chart(ShuChartCanvas, {
        type: 'bar',
        data: {
          ...
          datasets: [{
              ...
              // data: [
                // 1200000,0,0,0,
                // 5250000,0,0,0,0,0,0,0             
              // ],
              data:[shuJan,shuFeb,shuMar,shuApr,
                shuMei,shuJun,shuJul,shuAgt,shuSep,shuOkt,shuNov,shuDes
              ],
      ...
      document.getElementById('shu-legend').innerHTML = ShuChart.generateLegend();
    }
