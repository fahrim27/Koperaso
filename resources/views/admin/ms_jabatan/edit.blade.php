...
<div class="row row-cards row-deck">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('admin/ms_jabatan/update') }}" method="post">
                    <div class="row">
                        ...
                        @endif
                            ...
                            <input type="text" name="jabatan" class="form-control" value="{{ $MsJabatan->nama }}" autofocus>
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <input type="text" min="0" name="simp_pokok" class="form-control" id="nominal" value="{{ $MsJabatan->simp_pokok }}">
                        ...
                        @endif
                            ...
                            <input type="text" min="0" name="simp_wajib" class="form-control" id="nominal2" value="{{ $MsJabatan->simp_wajib }}">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="pull-right">
                                ...
                                <input type="hidden" name="id" value="{{$MsJabatan->id}}">
