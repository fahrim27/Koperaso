    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tambah Produk Simpanan Baru</h3>
                
            </div>
            <div class="card-body">
                <form action="{{ url('admin/simp_master/addnew') }}" method="post">
                    <div class="row">
                        @if ($errors->any('kode'))
                        ...
                        @if ($errors->any('akun_simp'))
                            ...
                            <select class="js-example-basic-single w-100" name="akun_simp" id="single" autofocus>
                                ...
                                @foreach ($AkunPsv as $p)
                                    <option value="{{ $p->kde_akun}}" {{ (old("akun_simp") == $p->kde_akun ? "selected":"") }}>{{ $p->nma_akun }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <input type="text" name="persen_jasa" class="form-control" value="" id="nominal">
