...
<div class="row row-cards row-deck">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('admin/ms_perusahaan/update') }}" method="post">
                    <div class="row">
                        ...
                        @endif
                            ...
                            <input type="text" name="inisial" class="form-control" value="{{ $Perush->inisial }}">
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <input type="text" name="nama" class="form-control" value="{{ $Perush->nama }}">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="pull-right">
                                ...
                                <input type="hidden" name="id" value="{{ $Perush->id }}">
