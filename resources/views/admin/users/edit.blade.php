    ...
    <div class="row row-cards row-deck">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/master_user/update') }}" method="post">
                        <div class="row">
                            @if ($errors->any('nama'))
        ...
        <div class="row">
            ...
            <select class="js-example-basic-single w-100" name="department" id="single3" autofocus>
                <option value="">-- Pilih Department --</option>
                <option value="CFO" {{ $User->department=='CFO' ? 'selected' : '' }}>CFO</option>
                <option value="HR" {{ $User->department=='HRD' ? 'selected' : '' }}>HRD</option>
                <option value="ADMIN" {{ $User->department=='ADMIN' ? 'selected' : '' }}>Administrator</option>
                <option value="USP" {{ $User->department=='USP' ? 'selected' : '' }}>Unit Simpan Pinjam</option>
                <option value="UJB" {{ $User->department=='UJB' ? 'selected' : '' }}>Unit Jual Beli</option>
