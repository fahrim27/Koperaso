    ...
    <div class="row row-cards row-deck">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('admin/master_anggota/update')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            @if ($errors->any('nik'))
                            ...
                            @endif
                                ...
                                <input type="text" name="nik" class="form-control" value="{{ $Anggota->nik }}" autofocus>
                        ...
                        {{--  <div class="row">
                            ...
                            @endif
                                ...
                                <input type="email"  disabled name="email" class="form-control" value="{{ $Anggota->email }}">
                            ...
                            @endif
                                ...
                                <input type="password" disabled name="password" class="form-control" value="********">
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" name="jenkel"
                                            value="Laki-laki" {{ $Anggota->jenis_kelamin == "Laki-laki" ? "checked" : "" }}>
                        ...
                        <div class="row">
                            ...
                            <select class="js-example-basic-single w-100" name="perusahaan" id="single" autofocus>
                                ...
                                @foreach ($Perush as $p)
                                    <option value="{{ $p->id }}" {{ $Anggota->id_perusahaan==$p->id ? 'selected' : '' }}>{{ $p->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        @endif
                            ...
                            <select class="js-example-basic-single w-100" name="department" id="single2" autofocus>
                                ...
                                @foreach ($Department as $d)
                                    <option value="{{ $d->id }}" {{ $Anggota->id_department==$d->id ? 'selected' : '' }}>{{ $d->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        @endif
                            ...
                            <select class="js-example-basic-single w-100" name="sts_karyawan" id="single3" autofocus>
                                ...
                                <option value="Permanen" {{ $Anggota->status_karyawan=='Permanen' ? 'selected' : '' }}>Permanen</option>
                                <option value="Kontrak" {{ $Anggota->status_karyawan=='Kontrak' ? 'selected' : '' }}>Kontrak</option>
                                <option value="Probation" {{ $Anggota->status_karyawan=='Probation' ? 'selected' : '' }}>Probation</option>
                            </select>
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <input type="text" name="ktp" class="form-control" value="{{ $Anggota->no_ktp }}">
                        ...
                        @endif
                            ...
                            <input type="text" name="telpon" class="form-control" value="{{ $Anggota->no_telpon }}">
                        ...
                        @endif
                            ...
                            <input type="text" name="kontak_darurat" class="form-control" value="{{ $Anggota->kontak_darurat }}">
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <textarea rows="2" class="form-control" name="domisili">
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <input type="text" name="rek_bank" class="form-control" value="{{ $Anggota->no_rekening }}">
                            <span class="help-block">{{ $errors->first('telpon') }}</span>
                        </div>
                        ...
                        @endif
                            ...
                            <select class="js-example-basic-single w-100" name="jabatan" id="single4" autofocus>
                                ...
                                @foreach ($Jabatan as $j)
                                    <option value="{{ $j->id }}" {{ $Anggota->id_jabatan==$j->id ? 'selected' : '' }}>{{ $j->nama }} - Rp. {{ number_format($j->simp_wajib,2) }}</option>
                                @endforeach
                            </select>
