...
<div class="row row-cards row-deck">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('admin/pby_master/addnew') }}" method="post">
                    <div class="row">
                        @if ($errors->any('kode'))
                        ...
                        @if ($errors->any('akun_produk'))
                            ...
                            <select class="js-example-basic-single w-100" name="akun_produk" id="single" autofocus>
                                ...
                                @foreach ($AkunAkt as $p)
                                    <option value="{{ $p->kde_akun}}" {{ (old("akun_produk") == $p->kde_akun ? "selected":"") }}>{{ $p->nma_akun }}</option>
                                @endforeach
                            </select>
                        ...
                        @if ($errors->any('akun_jasa'))
                            ...
                            <select class="js-example-basic-single w-100" name="akun_jasa" id="single2" autofocus>
                                ...
                                @foreach ($AkunPendpt  as $j)
                                    <option value="{{ $j->kde_akun }}" {{ (old("akun_jasa") == $j->kde_akun ? "selected":"") }}>{{ $j->nma_akun }}</option>
                                @endforeach
                            </select>
                        ...
                        @if ($errors->any('akun_adm'))
                            ...
                            <select class="js-example-basic-single w-100" name="akun_adm" id="single3" autofocus>
                                ...
                                @foreach ($AkunPendpt  as $a)
                                    <option value="{{ $a->kde_akun }}" {{ (old("akun_adm") == $a->kde_akun ? "selected":"") }}>{{ $a->nma_akun }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <input type="number" min="0" max="100" name="persen_jasa" class="form-control" value="0" step=".01">
                        ...
                        @endif
                            ...
                            <input type="number" min="0" max="100" name="persen_adm" class="form-control" value="0" step=".01">
