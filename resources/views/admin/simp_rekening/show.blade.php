...
@if (session()->has('flash_message'))
    <script>
        var urls = "{{Session::get('flash_message')}}";
        window.open(urls, '_blank', 'directories=no, toolbar=0,location=0,menubar=0');
    </script>
@endif
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm" formaction="{{url('admin/simp_mutasi/filter')}}"><i class="fa fa-table"></i> Tampilkan</button>
                            <button type="submit" class="btn btn-primary btn-sm" formaction="{{url('admin/simp_mutasi/cetak')}}" formtarget="_blank"><i class="fa fa-print"></i> Cetak Mutasi</button>
                          </div>
                        </div>
                      </div>
                    </form>                      
