        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Pesanan Anggota</h3>
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ url('admin/purchasing/detail/'.$JbOrder->id.'/cetak') }}" class="btn btn-info btn-sm"><i class="fa fa-print fa-fw"></i>  Cetak Surat</a>
