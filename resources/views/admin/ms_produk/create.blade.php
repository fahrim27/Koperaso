...
<div class="row row-cards row-deck">
    <div class="col-12">
        <div class="card">
            ...
            <form action="{{url('admin/master_produk/addnew')}}" method="POST" enctype="multipart/form-data">
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-6">                  
                  ...
                  @endif
                      ...
                      <input type="text" min="0" name="harga_beli" class="form-control" id="nominal2" >
                ...
                <div class="col-md-6">                  
                  ...
                  @endif
                      ...
                      <input type="text" min="0" name="harga" class="form-control" id="nominal" >
              ...
              <div class="row">                
                ...
                <div class="col-md-6">
                  <div class="form-group">                  
                      <label>Estimasi Pre Order (Hari)</label>
                      <input type="number" min="0" name="estimasi" class="form-control" value ="0">                      
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="stok" class="form-control" value ="0">                      
                    </div>
                  </div>
              </div>
              {{--  <div class="row">
                  ...
                  <div class="form-group">
                    <div class="form-check">
                        <label class="form-check-label">                                
                          <input type="checkbox" class="form-check-input" name="is_cicilan"> Skema Cicilan
                        </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    <div class="form-check">
                        <label class="form-check-label">                    
                          <input type="checkbox" class="form-check-input" name="is_bayarpenuh"> Bayar Penuh
                        </label>
                    </div>
                  </div>
                </div>
