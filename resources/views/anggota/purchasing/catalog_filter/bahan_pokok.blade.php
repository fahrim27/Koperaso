...
@section('content-app')
    <div class="row row-cards row-deck">
        <ul class="nav nav-pills nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{ url('anggota/purchasing/catalog/bahan_pokok') }}">Bahan Pokok</a>
            </li>
            <li class="nav-item">
...
<div class="row">
    <form action="{{ url('/anggota/purchasing/catalog/bahan_pokok/cari') }}" method="GET">                
